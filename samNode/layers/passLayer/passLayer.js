...
const { runQuery,
  ...
  sqsClient,
  SendMessageCommand,
  IS_OFFLINE } = require('/opt/baseLayer');
const { DateTime } = require('luxon');
<<<<<<< HEAD:lambda/passUtils.js
...
>>>>>>> 00b1f9f... Sam Build Files:samNode/layers/passLayer/passLayer.js
